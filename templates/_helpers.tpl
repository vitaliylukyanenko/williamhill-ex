...
{{- define "app.serviceAccountNameTest" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (print (include "app.fullname" .) "-test") .Values.serviceAccount.nameTest }}
{{- else -}}
...
Common labels
*/}}
{{- define "app.imageRenderer.labels" -}}
helm.sh/chart: {{ include "app.chart" . }}
{{ include "app.imageRenderer.selectorLabels" . }}
{{- if or .Chart.AppVersion .Values.image.tag }}
app.kubernetes.io/version: {{ .Values.image.tag | default .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
*/}}
{{- define "app.imageRenderer.selectorLabels" -}}
app.kubernetes.io/name: {{ include "app.name" . }}-image-renderer
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end -}}
...
*/}}
{{- define "app.password" -}}
{{- $secret := (lookup "v1" "Secret" (include "app.namespace" .) (include "app.fullname" .) ) -}}
  {{- if $secret -}}
...
*/}}
{{- define "app.podDisruptionBudget.apiVersion" -}}
